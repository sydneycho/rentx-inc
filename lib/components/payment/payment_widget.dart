                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Fill in the information below to place add your card',
                          style:
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelStyle:
                                FlutterFlowTheme.of(context).labelMedium,
                            hintText: 'Enter Visa card number...',
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Open Sans',
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    controller: _model.expirydateController,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          maxLines: 5,
                          minLines: 3,
                          validator: _model.billingaddressControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            await CardDetailsRecord.collection
                                .doc()
                                .set(createCardDetailsRecordData(
                                  billingAddress:
                                      _model.billingaddressController.text,
                                  cvv: int.tryParse(_model.cvvController.text),
                                  cardNo:
                                      int.tryParse(_model.textController4.text),
                                  expiryDate: _model.expirydateController.text,
                                  fullName:
                                      '${valueOrDefault(currentUserDocument?.firstName, '')}${valueOrDefault(currentUserDocument?.lastName, '')}',
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Your car details has been added successfully',
