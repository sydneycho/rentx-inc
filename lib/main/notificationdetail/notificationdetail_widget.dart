...
import 'notificationdetail_model.dart';
export 'notificationdetail_model.dart';
...
class _NotificationdetailWidgetState extends State<NotificationdetailWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<NotificationRecord>(
      stream: NotificationRecord.getDocument(widget.notificationDetail!),
      builder: (context, snapshot) {
        ...
        final notificationdetailNotificationRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
